...
public class ResnetModels {
    //Resnet building blocks
    public static Function convbn(input, filter_size, num_filters, strides=(1,1), init=he_normal()){
        c = Convolution(filter_size, num_filters, activation=None, init=init, pad=True, strides=strides, bias=False)(input)
        return new BatchNormalization(map_rank=1, normalization_time_constant=4096, use_cntk_engine=False)(c)
    }
}
